<x-layout class="pt-20">
    <div class="m-auto md:w-[40%] max-h-full flex flex-col justify-center">
        ...
        <form action="/recipes/create" method="POST" class="relative bg-gray-200 rounded-b-lg shadow" enctype="multipart/form-data">
            @csrf
            ...
            <div class="p-6 space-y-6">
                <div class="grid grid-cols-6 gap-6">
                    <div class="col-span-6 sm:col-span-3">
                        ...
                        <input type="text" name="title" id="title" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5" placeholder="History" >
                        @error('title')
                    ...
                    <div class="col-span-6 sm:col-span-3">
                        ...
                        <input type="text" name="excerpt" id="excerpt" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5" placeholder="History" >
                        @error('excerpt')
                            <p class="text-red-500 text-xs mt-2">{{ $message }}</p>
                        @enderror
                    </div>
                    <div class="col-span-6 sm:col-span-3">
                        ...
                        <textarea id="body" name="body" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500" placeholder="Quantum mechanics are..."></textarea>
                        @error('body')
                            <p class="text-red-500 text-xs mt-2">{{ $message }}</p>
                        @enderror
{{--                    <div class="col-span-6 sm:col-span-3">--}}
